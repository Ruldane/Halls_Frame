...
urlpatterns = [
    ...
    path('hallofframe/<int:pk>', views.DetailHall.as_view(), name='detail_hall'),
    ...
    # video
    path('hallofframe/<int:pk>/addvideo', views.add_video, name='add_video'),
